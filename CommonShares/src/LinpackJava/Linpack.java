...
public class Linpack {
    ...
    //Agregado por Jorge I Cadavid 01052011
    public double mflops_result_F = 0.0;
    public double residn_result_F = 0.0;
    public double time_result_F = 0.0;
    public double eps_result_F = 0.0;

  //Modificado por Jorge I Cadavid 01052011
...
*/
    ...
    //Modficado por Jorge I Cadavid 01052011
    /*System.out.println("Mflops/s: " + mflops_result +
	    "  Time: " + time_result + " secs" +
	    "  Norm Res: " + residn_result +
	    "  Precision: " + eps_result);*/
        mflops_result_F=mflops_result;
        time_result_F=time_result;
        residn_result_F=residn_result;
        eps_result_F=eps_result;
  }

  //Agregadas por Jorge I Cadavid 01052011
  public double getMflops()
    { return mflops_result_F;}

  public double getNormRes()
    {return residn_result_F;}

  public double getTimeinSecs()
    {return time_result_F;}
