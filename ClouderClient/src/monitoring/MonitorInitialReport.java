...
/**
 * This class provides the attributes to encapsulate the result of a monitor test. Among others, it includes cpu ussage, memory ussage and other statistics
 * @author GSot
 *
 */
public class MonitorInitialReport {
